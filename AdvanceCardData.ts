...
export class AdvanceCardData {
    ...
    public getDataLabelValue() {
        ...
        if (this.mainData.value === null || this.mainData.value === undefined ){
            return this.settings.dataLabelSettings.text
        }
        else if (this.mainData.hasValue || this.mainData.value != '' || this.mainData.value != null || this.mainData.value != undefined) {
        ...
        /*else {
            return this.settings.dataLabelSettings.text; //this.mainData.value;
        }*/
    }
