...
export class AdvanceCard {
    ...
    private getTextProperties(properties: ILabelTextProperties): TextProperties {
        return {
            ...
            textDecoration: properties.isunderline ? "underline" : "normal",
        };
    }
    ...
    public updateDataLabelTransform() {
        ...
        if (this.settings.dataLabelSettings.lineAlignment === "center"){ //general.alignment === "center") {
            if (this.prefixLabelExist() || this.postfixLabelExist()) {
                ...
                x = this.rootSVGSize.width / 2; //this.rootSVGSize.width / 2; //this.rootSVGSize.width / 2 - totalWidth / 2 + prefixLabelSize.width + prefixSpacing;
                dataLabelTextElement.attr("text-anchor", "middle"); //dataLabelTextElement.attr("text-anchor", "start");
            } else {
                x = this.rootSVGSize.width / 2; //this.rootSVGSize.width / 2;
                dataLabelTextElement.attr("text-anchor", "middle");
            }
            //x += this.settings.general.alignmentSpacing;
        } else if (this.settings.dataLabelSettings.lineAlignment === "left"){ //general.alignment === "left") {
            if (this.prefixLabelExist()) {
                x = this.settings.general.alignmentSpacing; //this.settings.general.alignmentSpacing; //this.settings.general.alignmentSpacing + prefixLabelSize.width + prefixSpacing;
                dataLabelTextElement.attr("text-anchor", "start");
            } else {
                x = this.settings.general.alignmentSpacing; //this.settings.general.alignmentSpacing;
                dataLabelTextElement.attr("text-anchor", "start");
            }
        } else if (this.settings.dataLabelSettings.lineAlignment === "right"){ //.general.alignment === "right") {
            if (this.postfixLabelExist()) {
                x = this.rootSVGSize.width - this.settings.general.alignmentSpacing; //this.rootSVGSize.width - this.settings.general.alignmentSpacing - postfixLabelSize.width - postfixSpacing;
                dataLabelTextElement.attr("text-anchor", "end");
            } else {
                x = this.rootSVGSize.width - this.settings.general.alignmentSpacing; //this.rootSVGSize.width - this.settings.general.alignmentSpacing;
                dataLabelTextElement.attr("text-anchor", "end");
            }
        }
        this.dataLabelGroupElement.attr("transform", translate(x, y + 5));
    }
    ...
    public updatePrefixLabelTransform() {
        ...
        if (this.settings.prefixSettings.lineAlignment === "center"){ //.general.alignment === "center") {
            let totalWidth = prefixLabelSize.width + prefixSpacing + dataLabelSize.width + postfixSpacing + postfixLabelSize.width;
            x = this.rootSVGSize.width / 2; // this.rootSVGSize.width / 2 - totalWidth / 2;
            //x += this.settings.general.alignmentSpacing;
            prefixLabelTextElement.attr("text-anchor", "middle");
        } else if (this.settings.prefixSettings.lineAlignment === "left"){  //.general.alignment === "left") {
            x = this.settings.general.alignmentSpacing;
            prefixLabelTextElement.attr("text-anchor", "start");
        } else if (this.settings.prefixSettings.lineAlignment === "right"){  //.general.alignment === "right") {
            x = this.rootSVGSize.width - this.settings.general.alignmentSpacing; // this.rootSVGSize.width - this.settings.general.alignmentSpacing - prefixSpacing - dataLabelSize.width - postfixSpacing - postfixLabelSize.width;
    ...
    public updatePostfixLabelTransform() {
        ...
        if (this.settings.postfixSettings.lineAlignment === "center"){ // .general.alignment === "center") {
            let totalWidth = prefixLabelSize.width + prefixSpacing + dataLabelSize.width + postfixSpacing + postfixLabelSize.width;
            x = this.rootSVGSize.width / 2; //this.rootSVGSize.width / 2 - totalWidth / 2 + prefixLabelSize.width + prefixSpacing + dataLabelSize.width + postfixSpacing;
            //x += this.settings.general.alignmentSpacing;
            postfixLabelTextElement.attr("text-anchor", "middle");
        } else if (this.settings.postfixSettings.lineAlignment === "left"){  //.general.alignment === "left") {
            x = this.settings.general.alignmentSpacing; //this.settings.general.alignmentSpacing + prefixLabelSize.width + prefixSpacing + dataLabelSize.width + postfixSpacing;
            postfixLabelTextElement.attr("text-anchor", "start");
        } else if (this.settings.postfixSettings.lineAlignment === "right"){  //.general.alignment === "right") {
            x = this.rootSVGSize.width - this.settings.general.alignmentSpacing; //this.rootSVGSize.width - this.settings.general.alignmentSpacing;
    ...
    private getYForTopRow() {
        ...
        if (this.settings.categoryLabelSettings.show) {
            ...
            y = this.rootSVGSize.height/4 ; //(0 - dataLabelSize.y) + (this.rootSVGSize.height - dataLabelSize.height) / 2;
        }
        return y;
    }
